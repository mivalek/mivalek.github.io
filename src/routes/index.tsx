...
export default component$(() => {
  return (
    <main class="m-auto my-8 max-w-3xl">
      ...
      <section>
        <div class="scroll-anchor" id="projects"></div>
        <h2>Projects</h2>
        <div class="my-6">
      ...
      <section>
        <div class="scroll-anchor" id="viz"></div>
        <h2>Visualisations</h2>
        <div>
          This is a small library of interactive apps I created to help students
          understand basic statistical concepts.
        </div>
        <ul class="xs:grid-cols-2 my-8 grid justify-items-center gap-8 sm:grid-cols-3">
      ...
      <section>
        <div class="scroll-anchor" id="teaching"></div>
        <h2>Teaching materials</h2>
        <div>
          Things should gradually appear here. Meanwhile, you can check out the{" "}
          <Link href="https://and2022.netlify.app/">website</Link> I made for
          the statistics in <span class="font-mono">R</span> module I taught at
          University of Sussex with my colleague Dr Jennifer Mankin. Be advised
          though, much of the content was written during COVID lockdowns so the
          humour is somewhat delirious...
        </div>
      </section>
    </main>
  );
